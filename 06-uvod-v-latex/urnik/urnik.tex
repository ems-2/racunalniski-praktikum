...
\usepackage{amsmath}     % nastavimo slovenščino
...
\begin{verbatim} % začetek okolja verbatim
<profesor>
   <ime>Janez</ime>
...
\end{verbatim}% konec okolja verbatim
...
tip (npr. \verb|bool|b v C++), kjer bi vrednost \verb|true| predstavljala
...
% Vsaka od vrstic v okolju `itemize` je en element naštevanja.
\begin{itemize}% začetek okolja itemize
...
\end{itemize}% konec okolja itemize
...
\begin{enumerate}% začetek okolja enumerate
...
\end{enumerate} % konec okolja enumerate
...
Naj bo $$\textit{n} = 100 $$ ter $ textit{s_1} $ sprememba urnika, ki nas je pripeljala v lokalni maksimum.~To
...
\end{verbatim}% konec okolja verbatims
