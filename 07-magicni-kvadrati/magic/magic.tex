...
\usepackage{url}
\usepackage{graphicx}
\date{}  % This suppresses the date, which you already have
\author{}  % This suppresses the author
...
\begin{definicija}
   \emph{\color{RubineRed}{Magični kvadrat}} reda $n$ je nabor $n^2$ različnih števil,
